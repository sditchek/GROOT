...
alldrops0=alldrops_stm{loop1};
                        ...
                        if size(identconvobssubtype,2)>1
                            ...
                            save([identout,'RESULTS/',identfold,'VERIFICATION/OBS/',upper(identhwrf),identn(end-1:end),'_conv.mat'],'identdroplist','identdropcyc','identobscyc','valuescomp','denmapcomp','listcomp','identdropsbycycle','-v7.3')
                        end            
                        close all
                        %% Track with Obs
