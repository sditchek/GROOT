...
set -A expyears 2020 2021 2022					# years included (i.e., YYYY) - for more than one year list with spaces between them
numyears=3							# number of years in expyears - the number must match!	
atcfoutput=/scratch2/AOML/aoml-hafs1/Ghassan.Alaka/adeck/GPLOT_2022/              # location of your atcf or adeck output
...
set -A expfold HF3S HF3A HWRF	 	# exp folders (e.g., STORM1EXPERIMENT1 STORM2EXPERIMENT1 STORM1EXPERIMENT2 STORM2EXPERIMENT2)
set -A expnew HF3S HF3A HWRF            # names of exps (these will be the names on the graphics e.g., EXPERIMENT1 EXPERIMENT1 EXPERIMENT2 EXPERIMENT2)
...
startdate1="2020-06-08 12"
enddate1="2022-07-22 00"
