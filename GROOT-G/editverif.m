...
identexp=[{'HF3A'};{'HWRF'}]; 		 	                                  % folder name of all experiments - must match "expnew" in runverif.ksh and last must be the BASELINE
...
fprintf(fid,'%s\n',['initpath="',[identout,'RESULTS/',identfold,'VERIFICATION/**/**/',upper(tmpcasefold),yearsdone(end-1:end),'*'],'"']);
