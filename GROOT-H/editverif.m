...
if identhafsmodel==1
   identconvid_filename=[{'_t_anl'};{'_rw_anl'};{'_rw_anl'};{'_t_anl'}];   % if identhafsmodel=1, filenames of data desired ensuring it starts with "_" and equals length of identconvobstype
end
