...
identexp=[{'ALL'};{'NONS'};{'NOIC'};{'NOG4'}]; 		   	        % folder name of all experiments: 1) must match "expnew" in runverif.ksh, 2) first experiment MUST be the one with al the obs assimilated, and 3) last experiment MUST be the BASELINE
