...
identout=['/scratch4/AOML/aoml-hafs1/Sarah.D.Ditchek/GROOT/GROOT-H/'];  	 % top-level directory path for results folder - must include end "/"
identgroot=['/scratch4/AOML/aoml-hafs1/Sarah.D.Ditchek/GROOT/GROOT-H/GROOT-PR/'];% path of GROOT-PR directory (i.e., ${homepath}/GROOT/GROOT-H/GROOT-PR/, where homepath is same as in runverif.ksh) - must include end "/"
