...
# Set Experiments
set -A expfold FIONA-ALL FIONA-NOG4 IAN-ALL IAN-NOG4 NICOLE-ALL NICOLE-NOG4 ELSA-ALL ELSA-NOG4 HENRI-ALL HENRI-NOG4 IDA-ALL IDA-NOG4 SAM-ALL SAM-NOG4 ISAIAS-ALL ISAIAS-NOG4 LAURA-ALL LAURA-NOG4 MARCO-ALL MARCO-NOG4 DELTA-ALL DELTA-NOG4 ZETA-ALL ZETA-NOG4 FRANKLIN-ALL FRANKLIN-NOG4 IDALIA-ALL IDALIA-NOG4 LEE-ALL LEE-NOG4 # names of the folders in scrub and noscrub that you want to include in the graphics # e.g.: STORM1EXPERIMENT1 STORM2EXPERIMENT1 STORM1EXPERIMENT2 STORM2EXPERIMENT2
set -A expnew ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 ALL NOG4 # names of exps (these will be the names on the graphics) # e.g.: EXPERIMENT1 EXPERIMENT1 EXPERIMENT2 EXPERIMENT2
numfold=30                                              # number of entries in expnew
