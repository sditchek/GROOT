...
g(:,:,1) = umag > 7.5./1.94384 & umag <= 47.5./1.94384;
g(:,:,2) = umag > 17.5./1.94384 & umag <= 47.5./1.94384;
g(:,:,3) = umag > 27.5./1.94384
g(:,:,4) = (umag > 37.5./1.94384 & umag <= 47.5./1.94384) | (umag > 57.5./1.94384 & umag <= 97.5./1.94384);
g(:,:,5) = umag > 67.5./1.94384
g(:,:,6) = (umag > 77.5./1.94384 & umag < 97.5./1.94384) | umag > 107.5./1.94384;
g(:,:,7) = umag > 87.5./1.94384 & umag < 97.5./1.94384 | umag > 117.5./1.94384;
g(:,:,8) = umag > 127.5./1.94384;
g(:,:,9) = (umag > 2.5./1.94384 & umag <= 7.5./1.94384) | (umag > 12.5./1.94384 & umag <= 17.5./1.94384);
g(:,:,10) = umag > 22.5./1.94384 & umag <= 27.5./1.94384;
g(:,:,11) = (umag > 32.5./1.94384 & umag <= 37.5./1.94384) | (umag > 52.5./1.94384 & umag <= 57.5./1.94384);
g(:,:,12) = (umag > 42.5./1.94384 & umag <= 47.5./1.94384) | (umag > 62.5./1.94384 & umag <= 67.5./1.94384);
g(:,:,13) = (umag > 72.5./1.94384 & umag <= 77.5./1.94384) | (umag > 102.5./1.94384 & umag <= 107.5./1.94384); 
g(:,:,14) = (umag > 82.5./1.94384 & umag <= 87.5./1.94384) | (umag > 112.5./1.94384 & umag <= 117.5./1.94384);
g(:,:,15) = (umag > 92.5./1.94384 & umag <= 97.5./1.94384) | (umag > 122.5./1.94384 & umag <= 127.5./1.94384);
g(:,:,16) = umag > 47.5./1.94384;
g(:,:,17) = umag > 97.5./1.94384;
g(:,:,18) = true(a,b);
