...
#SBATCH -J STMCLEAN         # XXXX: Job Name | change to whatever you'd like
...
echo "Thank you for using GROOT! Check out your STORM GRID results in the ${homepath}/GROOT/GROOT-H/RESULTS/ directory. If you have any questions, please contact Sarah Ditchek (CIMAS-AOML)." > ${homepath}/SUBMISSION_STORMGRID_FINISHED.txt
