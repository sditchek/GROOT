#!/bin/ksh
#SBATCH -t 03:00:00         # XXXX: Time Limit | generally sufficient; may need to increase it
...
#SBATCH -J SYNGR	    # XXXX: Job Name | change to whatever you'd like
...
then
	...
	if [ $numvar -lt $lenvar ]
	then
		sbatch ${scriptspath}/matlabsynopticvar_$numvar.ksh $numvar $scriptspath $outputpath $homepath $numcyc $numarrc
	else
