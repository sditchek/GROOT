                ...
                if isnan(BT_lat(identloop,identfhr))==1
                    ...
                    for varloop=1:9
                        ...
                        for pl=pla % 850, 500, 200 average sigma levels land mask
                            ...
                            %f = getframe(hfig);
                            print([identhwrfda,'/',identn,'_',identinittimesunique(identloop,:),'_PLEV',num2str(plev(cnt)),'_',savename,'_D02_HWRFDA'],'-dpng');
                        ...
                        for pl=pla % 850 (22), 500 (37), 200 (54) average sigma levels
                            ...
                            clP=get(cl9,'Position');
                            set(cl9,'Position',[clP(1)+.02 clP(2)+.02 0.01 clP(4)-.04])
                            print([identhwrfda,'/',identn,'_',identinittimesunique(identloop,:),'_PLEV',num2str(plev(cnt)),'_',savename,'_D03_HWRFDA'],'-dpng');
                            close all 
                            cnt=cnt+1;
                        end                        
                        if varloop==9
                            ...
                            for pl=1                                 
                                ...
                                %f = getframe(hfig);
                                print([identhwrfda,'/',identn,'_',identinittimesunique(identloop,:),'_AZAV_',savename,'_D02_HWRFDA'],'-dpng');
                                %imwrite(f.cdata,[identhwrfda,'/',identn,'_',identinittimesunique(identloop,:),'_PLEV',num2str(plev(cnt)),'_',savename,'_D02_HWRFDA.png'],'pdf');
                                close all 
                                cnt=cnt+1;
                            end
                            ...
                            for pl=1                                 
                                ...
                                set(cl9,'Position',[clP(1)+.01 clP(2)+.02 0.01 clP(4)-.04])
                                %f = getframe(hfig);
                                print([identhwrfda,'/',identn,'_',identinittimesunique(identloop,:),'_AZAV_',savename,'_D03_HWRFDA'],'-dpng');
                                %imwrite(f.cdata,[identhwrfda,'/',identn,'_',identinittimesunique(identloop,:),'_PLEV',num2str(plev(cnt)),'_',savename,'_D02_HWRFDA.png'],'pdf');
                                close all 
                                cnt=cnt+1;
                            end
                ...
                if sum(isnan(BT_lat(identloop,:)))==size(BT_lat,2)
                    ...
                    for identexploop=identvarexp0%1:size(identexp,1)
                        ...
                        if levs==1
                            ...
                            if identplan==1
                                if isfile([identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_PLEV',num2str(plev(7)),'_',savename,'_PLAN.png'])==0
                                    for loop=1:size(var_f,4)
                                        if isnan(BT_lat(identloop,loop))==1 || (identvar>=80 && identvar <=85)
                                            ...
                                            for loop1=identpresplan % 850,700,500,200 %1:size(var_f,3)                                             
                                                ...
                                                f = getframe(hfig);
                                                imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_PLEV',num2str(plev(loop1)),'_',savename,'_PLAN.png'],'png');
                            ...
                            if isfile([identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_',savename,'_RPAZAV.png'])==0
                                for loop=1:size(vectRAW,3) 
                                    if isnan(BT_lat(identloop,loop))==1
                                        ...
                                        set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                        f = getframe(hfig);
                                        imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_',savename,'_RPAZAV.png'],'png');
                            ...
                            if isfile([identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_',savename,'_3DRTAZAV.png'])==0
                                for loop=identpresplan % 850,700,500,200 %1:size(var_f,3)
                                    ...
                                    set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                    f = getframe(hfig);
                                    imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_PLEV',num2str(plev(loop)),'_',savename,'_3DRTAZAV.png'],'png');
                            ...
                            if isfile([identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_EVO_',filerad,'_',savename,'.png'])==0
                                for loop=1
                                    tmpplt=navi;
                                    tmpplt(tmpplt<cmin)=cmin;
                                    set(0,'defaultfigurecolor',[1 1 1]) % figure background color
                                    ...
                                    set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                    f = getframe(hfig);
                                    imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_EVO_',filerad,'_',savename,'.png'],'png');
                        ...
                        elseif levs==0
                            ...
                            if identplan==1
                                if isfile([identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_',savename,'_PLAN.png'])==0                            
                                    for loop=1:size(var_f,3) % (lon)x(lat)x(fhr)
                                        ...
                                        set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                        f = getframe(hfig);
                                        imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_',savename,'_PLAN.png'],'png');
                            ...
                            if isfile([identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_',savename,'_2DRTAZAV.png'])==0
                                for loop=1 % (radius)x(fhr) for the current (cycle)
                                    ...
                                    set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                    f = getframe(hfig);
                                    imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/SYNOPTIC/',identn,'_',identinittimesunique(identloop,:),'_',savename,'_2DRTAZAV.png'],'png');
                ...
                if sum(isnan(BT_lat(identloop,:)))==size(BT_lat,2)
                    ...
                    for identexploop=identvarexp0%1:size(identexp,1)
                        ...
                        if levs==1
                            %% Creates Plan-View plots for each init/fhr at each level: var_f=(lon)x(lat)x(plev)x(fhr)
                            if identplan==1
                                if isfile([identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_PLEV',num2str(plev(7)),'_',savename,'_PLAN.png'])==0
                                for loop=1:size(var_f,4)
                                    if isnan(BT_lat(identloop,loop))==1 || (identvar>=80 && identvar <=85)
                                    else
                                        for loop1=identpresplan % 850,700,500,200 %1:size(var_f,3)
                                            ...
                                            set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                            f = getframe(hfig);
                                            imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_PLEV',num2str(plev(loop1)),'_',savename,'_PLAN.png'],'png');
                            ...
                            %% For 3D only, make a (radius)x(plev) plot for each fhr. This does not exist for the 1-level 2D plots.
                            if isfile([identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_',savename,'_RPAZAV.png'])==0
                                for loop=1:size(vectRAW,3)                                    
                                    if isnan(BT_lat(identloop,loop))==1
                                    else
                                        tmpplt=vectRAW;
                                        ...
                                        set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                        f = getframe(hfig);
                                        imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_',savename,'_RPAZAV.png'],'png');
                            ...
                            %% For 3D only, make a (radius)x(fhr) plot for each level. This is the default for the 1-level 2D plots.
                            if isfile([identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_',savename,'_3DRTAZAV.png'])==0
                                for loop=identpresplan
                                    ...
                                    set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                    f = getframe(hfig);
                                    imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_PLEV',num2str(plev(loop)),'_',savename,'_3DRTAZAV.png'],'png');
                            ...
                            for tmploop=1:size(innerradu,2)
                                ...
                                clear TotalA RingA vals_d Ddi
                                if isfile([identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_EVO_',filerad,'_',savename,'.png'])==0
                                    for loop=1
                                        tmpplt=navi(:,:,tmploop);
                                        tmpplt(tmpplt<cmin)=cmin;
                                        set(0,'defaultfigurecolor',[1 1 1]) % figure background color
                                        ...
                                        set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                        f = getframe(hfig);
                                        imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_EVO_',filerad,'_',savename,'.png'],'png');
                        ...
                        elseif levs==0
                            %% Creates Plan-View plots for each init/fhr: var_f=(lon)x(lat)x(fhr)
                            if isfile([identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((1-1)*3),'_',savename,'_PLAN.png'])==0
                                for loop=1:size(var_f,3) % (lon)x(lat)x(fhr)
                                    if isnan(BT_lat(identloop,loop))==1
                                    else
                                    tmpplt=var_f;
                                    ...
                                    set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                    f = getframe(hfig);
                                    imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_',savename,'_PLAN.png'],'png');
                            ...
                            if isfile([identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_',savename,'_2DRTAZAV.png'])==0
                                for loop=1 % (radius)x(fhr) for the current (cycle)
                                    tmpplt=vectRAW;
                                    tmpplt(tmpplt<cmin)=cmin;
                                    set(0,'defaultfigurecolor',[1 1 1]) % figure background color
                                    ...
                                    set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                                    f = getframe(hfig);
                                    imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_',savename,'_2DRTAZAV.png'],'png');
        ...
        for identloop=identbatch
            if isnan(BT_lat(identloop,1))==1
                ...
                for identexploop=1:size(identexp,1)
                    identexp0=identexp{identexploop};
                    clear tmp
                    if isfile([identfields,'/',identexp0,'/FIGURES/',identn,'_',identinittimesunique(identloop,:),'_VWS.png'])==0
                    % This will loop over EXP experiments - same code for each!
                    ...
                    tmp(2)=isfile([identfields,'/',identexp0,'/MATFILES/',identhwrf,'_synoptic_',identexp0,'_',identinittimesunique(identloop,:),'_v-component_of_wind_isobaric.mat'])==1;
                        if sum(tmp)==2
                            ...
                            set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0.04, .72, 0.96]); % maximize figure window
                            f = getframe(hfig);
                            imwrite(f.cdata,[identfields,'/',identexp0,'/FIGURES/',identn,'_',identinittimesunique(identloop,:),'_VWS.png'],'png');
                            %print([identfields,'/',identexp,'/FIGURES/STORM/',identn,'_',identinittimesunique(identloop,:),'_FHR',num2str((loop-1)*3),'_',savename,'_3DRTAZAV'],'-dpdf','-r200');
                            close all 
