...
rm -f ${homepath}/GROOT/GROOT-H/startverif.mat
rm -f ${homepath}/GROOT/GROOT-H/indivparams.mat
rm -f ${homepath}/GROOT/GROOT-H/common.txt
rm -f ${homepath}/GROOT/GROOT-H/commonverif.txt
