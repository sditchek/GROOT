...
for identremoveinvest=1
    ...
    if identindivstorm==1
		...
		stormsdone{stmdn}=identhwrf;end; %GROOT-G Change End
				...
				identdr=dir([identgroovpr,identexp{tmp},'/atcf/',identtmp1,'*','atcfunix']); %GROOT-G Change
		...
		% Identify which cycle numbers will be running
            ...
            if exist('breakscript','var')==1
                ...
                for track=1
                    ...
                    f = getframe(hfig);
					if identeps==1;filename=[identtrackint,'/',identn,'_track'];set(gcf,'PaperPositionMode','auto');print([filename,'.eps'],'-depsc','-r0');else;imwrite(f.cdata,[filename,'.png'],'png');end;					
                end
                %% %%%%%%%%%%%%%%%%%%%% %%
